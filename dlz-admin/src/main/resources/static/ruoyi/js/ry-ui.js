...
(function ($) {
    $.extend({
    	...
    	table: {
            // 初始化表格参数
            init: function(options,tableId,toolbar) {
            	var defaults = {
            		id: $.common.isEmpty(tableId)? "bootstrap-table" : tableId,
        		    ...
        		    pageSize: 10,
        		    pageList: [10, 25, 50],
        		    toolbar: $.common.isEmpty(toolbar)? "toolbar" : toolbar,
        		    striped: false,
        		    escape: false,
        		    firstLoad: true,
        		    showFooter: false,
